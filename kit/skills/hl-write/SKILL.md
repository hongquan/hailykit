...
| `scripts/style-stats.mjs` | Whole-manuscript style facts (phrase tics, verbatim repeats, ending/opening cadence) for the Verify sweep; also run advisorily over `research/style-samples/` at Recon |
