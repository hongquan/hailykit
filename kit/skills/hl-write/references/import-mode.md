...
1. Delegate to `haily-editor`'s Import Extraction mode (`kit/agents/haily-editor.md`) — pass the frozen chapter text and the current `bible/plot.md` foreshadowing registry so the editor reuses existing threads instead of minting duplicates.
